...
class vuContestTechLong extends roomClientVue{
    constructor(vue, meetingShortname, xContest, writing=true){
        ...
        super(`contests/${xContest}@${meetingShortname}`, writing, true, '/static/rContestTechLongClient.js', 'rContestTechLongClient', '')
