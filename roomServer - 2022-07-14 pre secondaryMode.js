...
class roomServer{
     ...
     */
    constructor(eventHandler, mongoDb, logger, name, storeReadingClientInfos=false, maxWritingTicktes=-1, conflictChecking=false, dynamicRoom=undefined, reportToSideChannel=true, keepWritingTicket=true){
    ...
    async initMongoStack(){
        ...
        try {
            ...
            if (this.keepWritingTicket){
                ...
                if (this.offlineWritingClients.length>0){
                    this.offlineWritingClients = {};
                    this.storeOfflineWritingClients();
                }
            }
...
*/
    ...
    finishedFunc(){
        if (this.functionsWorkStack.length>0){
            ...
            if (obj.type=="ws"){
                ...
                this._startWriteFunctionServer(obj.funcName, obj.data, obj.resolve, obj.reject, obj.id, obj.tabIdExclude); 
     ...
     */
    async serverFuncWrite(funcName, data, id=undefined, tabIdExclude=undefined){
        ...
        return new Promise((resolve, reject)=>{
            if (this.busy){
                ...
                this.functionsWorkStack.splice(insertPos,0,{funcName, data, resolve, reject, type:"server", id, tabIdExclude}) // "server"-type request
                ...
                // do start the function
                this._startWriteFunctionServer(funcName, data, resolve, reject, id, tabIdExclude); 
            }
        })
