...
-- -----------------------------------------------------
-- Table `eventsincompetition`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventsincompetition` (
  `xCompetition` INT UNSIGNED NOT NULL,
  `xEvent` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`xCompetition`, `xEvent`),
  INDEX `fk_eventsInCompetition_events1_idx` (`xEvent` ASC),
  CONSTRAINT `fk_eventsInCompetition_competitions1`
    FOREIGN KEY (`xCompetition`)
    REFERENCES `athletica3`.`competitions` (`xCompetition`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_eventsInCompetition_events1`
    FOREIGN KEY (`xEvent`)
    REFERENCES `athletica3`.`events` (`xEvent`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `eventsincombined`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventsincombined` (
  `xCombinedEvent` INT UNSIGNED NOT NULL,
  `xEvent` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`xCombinedEvent`, `xEvent`),
  INDEX `fk_eventsInCombined_events1_idx` (`xEvent` ASC),
  CONSTRAINT `fk_eventsInCombined_combinedEvents1`
    FOREIGN KEY (`xCombinedEvent`)
    REFERENCES `athletica3`.`combinedevents` (`xCombinedEvent`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_eventsInCombined_events1`
    FOREIGN KEY (`xEvent`)
    REFERENCES `athletica3`.`events` (`xEvent`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `combinedeventsincompetition`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `combinedeventsincompetition` (
  `xCombinedEvent` INT UNSIGNED NOT NULL,
  `xCompetition` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`xCombinedEvent`, `xCompetition`),
  INDEX `fk_combinedEventsInCompetition_competitions1_idx` (`xCompetition` ASC),
  CONSTRAINT `fk_combinedEventsInCompetition_combinedEvents1`
    FOREIGN KEY (`xCombinedEvent`)
    REFERENCES `athletica3`.`combinedevents` (`xCombinedEvent`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_combinedEventsInCompetition_competitions1`
    FOREIGN KEY (`xCompetition`)
    REFERENCES `athletica3`.`competitions` (`xCompetition`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- Table `teamstarts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `teamstarts` (
  `xInscription` INT UNSIGNED NOT NULL,
  `xTeam` INT UNSIGNED NOT NULL,
  `xStart` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`xInscription`, `xTeam`, `xStart`),
  INDEX `fk_table1_starts1_idx` (`xStart` ASC),
  CONSTRAINT `fk_table1_teamInscriptions1`
    FOREIGN KEY (`xInscription` , `xTeam`)
    REFERENCES `athletica3`.`teaminscriptions` (`xInscription` , `xTeam`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_table1_starts1`
    FOREIGN KEY (`xStart`)
    REFERENCES `athletica3`.`starts` (`xStart`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'NOT USED YET: this table allows that not simply all starts of an athlete are counted for a team. This table can stay empty, then every start of an athlete counts for every team he starts. If this shall be differentiated, then this table must be used.';
...
CREATE TABLE IF NOT EXISTS `disciplinesonsite` (
  ...
  INDEX `fk_disciplinesonsite_basedisciplines1_idx` (`xBaseDiscipline` ASC),
  INDEX `fk_disciplinesonsite_sites1_idx` (`xSite` ASC),
  ...
  CONSTRAINT `fk_disciplinesonsite_basedisciplines1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_disciplinesonsite_sites1`
    FOREIGN KEY (`xSite`)
    REFERENCES `sites` (`xSite`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
