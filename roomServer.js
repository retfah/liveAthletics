...
*/
     ...
     */
    _onRoomReady(){
        // the writing tickets cannot be revokes before the room is ready; thus, if the mode was already set to secondary, we now have to revoke the writing tickets
