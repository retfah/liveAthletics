...
class rClubs extends roomServer{
    ...
    async deleteClub(data){
        ...
        if (valid){
            ...
            let [ind, club] = this.findObjInArrayByProp(this.data, 'xClub', data)
            ...
            [ind, ] = this.findObjInArrayByProp(this.data, 'xClub', data) // must be reqpeated, since the index could have changed due to the async call.
            if (ind>=0){
    ...
    async updateClub(data){
        ...
        if (valid) {
            ...
            let [i, o] = this.findObjInArrayByProp(this.data, 'xClub', data.xClub);
            if (i<0){
